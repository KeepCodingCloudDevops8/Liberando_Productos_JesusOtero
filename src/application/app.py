...
BYEBYE_REQUESTS = Counter('byebye_requests_total', 'Total number of requests to byebye endpoint')
...
class SimpleServer:
    ...
    async def say_bye():
        ...
        # Incrementar contador para registrar el total de llamadas en este endpoint
        REQUESTS.inc()
        # Increment counter used for register the total number of calls in the main endpoint
        BYEBYE_REQUESTS.inc()
        return {"msg": "Bye Bye"}
